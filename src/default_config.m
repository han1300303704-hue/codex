...
cfg.beam.quantization_offset_search = true;
cfg.beam.quantization_offset_trials = 16;
cfg.beam.quantization_optimize_bits_max = 2;
cfg.beam.quantization_greedy_passes = 0;
cfg.beam.relaxed_quantization = true;
cfg.beam.relaxed_quantization_bits_max = 2;
cfg.beam.relaxed_power_iterations = 12;
cfg.beam.relaxed_min_center_gain_ratio = 0.98;
cfg.beam.cvx_sdr_quantization = false;
cfg.beam.cvx_sdr_bits_max = 2;
cfg.beam.cvx_sdr_max_full_ant = 96;
